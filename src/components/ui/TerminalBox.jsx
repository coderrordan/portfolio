...
export default function TerminalBox() {
  ...
  return (
    <div className="terminal-box" aria-label={UI.terminalLabel}>
      <div className="terminal-bar"><span><i /><i /><i /></span><strong>{UI.terminalTitle}</strong></div>
      <div className="terminal-body">
        <p className="terminal-command"><span>›</span> {UI.terminalLoad}</p>
        {TERMINAL_LINES.map((line) => (
          <div key={line.label} className={`terminal-line terminal-${line.type}`}>
